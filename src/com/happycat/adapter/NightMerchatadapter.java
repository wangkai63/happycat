...
import com.happycat.adapter.DayMerchatadapter.holderView;
...
public class NightMerchatadapter extends BaseAdapter {
	...
	public NightMerchatadapter(List<NightMerchatBean> list, Context context) {
		super();
		this.list = list;
	...
	public List<NightMerchatBean> getList() {
		return list;
	}

	public void setList(List<NightMerchatBean> list) {
		this.list = list;
	}
