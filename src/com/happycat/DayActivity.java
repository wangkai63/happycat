...
import com.happycat.adapter.DayMerchatadapter;
...
public class DayActivity extends Activity {
	...
	ImageView imageView;
	// 数据来源
	List<DayMerchatBean> list = new ArrayList<DayMerchatBean>();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		imageView.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(DayActivity.this, SyJsActivity.class);
	...
	private void initDatas() {
		adapter = new DayMerchatadapter(list,DayActivity.this);
		listView.setAdapter(adapter);
		// 向服务器发送请求，查询数据
		url = "http://" + MyApplication.getIp()
				+ ":8080/happycat/SelectMerchat?oid=10";
		...
		new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> arg0) {
				...
				// 使用GSon框架进行json解析
				Gson gson = new Gson();
				Type typeOfT = new TypeToken<List<DayMerchatBean>>() {
				}.getType();
				List<DayMerchatBean> resultlist = gson.fromJson(result, typeOfT);
